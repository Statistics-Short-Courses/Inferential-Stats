...
What if we were interested in looking at body mass of penguins compared to their flipper length? We are dealing with two continuous, numerical variables in this case, and can consider a scatterplot.
...
Like we did with the histogram, we can add some colour, change the shape of the points, and give informative labels.
...
Clearly, as the body mass of a penguin increases, so does the flipper length. We can describe this a strong positive linear relationship.

If you have a categorical variable and numerical variable, you can do boxplot. Let's see how the body mass of penguins changes between species.
