...
**NOTE: At this stage, we will drop missing values from the dataset. If you are interested in understanding missing values and when it is appropriate to drop them, you can refer to the *Data Visualisation in R* short course.**
