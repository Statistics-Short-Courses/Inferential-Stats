...
`D6_1` represents the average commute time from home to work and `D6_2` represents the average commute time from work to home in minutes. Rather than renaming both of these, we can combine them to create a single `Commute_Time` variable that reflects the total daily commute.
